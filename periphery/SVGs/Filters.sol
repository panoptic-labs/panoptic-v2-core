...
library Filters {
    ...
    function rarity6() internal pure returns (string memory) {
        return
            '<feColorMatrix type="matrix" values=".33 .33 .33 0 0 .33 .33 .33 0 0 .33 .33 .33 0 0 0 0 0 1 0" in="SourceGraphic" result="colormatrix"/><feComponentTransfer in="colormatrix" result="componentTransfer"><feFuncR type="table" tableValues="0 0.21 0.36 0.73 0.98 1"/><feFuncG type="table" tableValues="0 0.18 0.33 0.71 0.94 1"/><feFuncB type="table" tableValues="0 0.26 0.44 0.78 0.9 1"/><feFuncA type="table" tableValues="0 1"/></feComponentTransfer><feBlend mode="normal" in="componentTransfer" in2="SourceGraphic" result="blend"/><feGaussianBlur in="blend" stdDeviation="0.25" />';
    }

    function rarity7() internal pure returns (string memory) {
        return
            '<feColorMatrix type="matrix" values=".33 .33 .33 0 0 .33 .33 .33 0 0 .33 .33 .33 0 0 0 0 0 1 0" in="SourceGraphic" result="colormatrix"/><feComponentTransfer in="colormatrix" result="componentTransfer"><feFuncR type="table" tableValues="0 0.24 0.69 0.95 0.97 1"/><feFuncG type="table" tableValues="0 0.13 0.21 0.43 0.86 1"/><feFuncB type="table" tableValues="0 0.42 0.59 0.73 0.78 1"/><feFuncA type="table" tableValues="0 1"/></feComponentTransfer><feBlend mode="screen" in="componentTransfer" in2="SourceGraphic" result="blend"/><feGaussianBlur in="blend" stdDeviation="0.25" />';
    }
    ...
    function rarity9() internal pure returns (string memory) {
        return
            '<feColorMatrix type="matrix" values=".33 .33 .33 0 0 .33 .33 .33 0 0 .33 .33 .33 0 0 0 0 0 1 0" in="SourceGraphic" result="colormatrix"/><feComponentTransfer in="colormatrix" result="componentTransfer"><feFuncR type="table" tableValues="0 0.08 0.36 0.31 0.88 1 1"/><feFuncG type="table" tableValues="0 0.07 0.34 0.65 0.29 0.74 1"/><feFuncB type="table" tableValues="0 0.29 1 0.89 0.78 0.73 1"/><feFuncA type="table" tableValues="0 1"/></feComponentTransfer><feBlend mode="hard-light" in="componentTransfer" in2="SourceGraphic" result="blend"/><feGaussianBlur in="blend" stdDeviation="0.25" />';
    }

    function rarity10() internal pure returns (string memory) {
        return
            '<feColorMatrix type="matrix" values=".33 .33 .33 0 0 .33 .33 .33 0 0 .33 .33 .33 0 0 0 0 0 1 0" in="SourceGraphic" result="colormatrix"/><feComponentTransfer in="colormatrix" result="componentTransfer"><feFuncR type="table" tableValues="0.17 0.36 0.78 0.22 0.78 1"/><feFuncG type="table" tableValues="0.18 0 0 0.9 1 1"/><feFuncB type="table" tableValues="0.12 0.23 1 0.58 0.9 1"/><feFuncA type="table" tableValues="0 1"/></feComponentTransfer><feBlend mode="overlay" in="componentTransfer" in2="SourceGraphic" result="blend"/><feGaussianBlur in="blend" stdDeviation="0.25" />';
    }
    ...
    function rarity17() internal pure returns (string memory) {
        return
            '<feColorMatrix type="matrix" values=".33 .33 .33 0 0 .33 .33 .33 0 0 .33 .33 .33 0 0 0 0 0 1 0" in="SourceGraphic" result="colormatrix"/><feComponentTransfer in="colormatrix" result="componentTransfer"><feFuncR type="table" tableValues="0.05 0.85 0.99 1"/><feFuncG type="table" tableValues="0.18 0.33 1 1"/><feFuncB type="table" tableValues="0.04 0.48 0.48 1"/><feFuncA type="table" tableValues="0 1"/></feComponentTransfer><feBlend mode="normal" in="componentTransfer" in2="SourceGraphic" result="blend"/><feGaussianBlur in="blend" stdDeviation="0.25" />';
    }
    ...
    function rarity20() internal pure returns (string memory) {
        return
            '<feColorMatrix type="matrix" values=".33 .33 .33 0 0 .33 .33 .33 0 0 .33 .33 .33 0 0 0 0 0 1 0" in="SourceGraphic" result="colormatrix"/><feComponentTransfer in="colormatrix" result="componentTransfer"><feFuncR type="table" tableValues="0.98 0.58 0.29"/><feFuncG type="table" tableValues="1 0.3 0.24"/><feFuncB type="table" tableValues="0.91 0.62 0.4"/><feFuncA type="table" tableValues="0 1"/></feComponentTransfer><feBlend mode="normal" in="componentTransfer" in2="SourceGraphic" result="blend"/><feGaussianBlur in="blend" stdDeviation="0.25" />';
    }
    ...
    function rarity23() internal pure returns (string memory) {
        return
            '<feColorMatrix type="matrix" values=".33 .33 .33 0 0 .33 .33 .33 0 0 .33 .33 .33 0 0 0 0 0 1 0" in="SourceGraphic" result="colormatrix"/><feComponentTransfer in="colormatrix" result="componentTransfer"><feFuncR type="table" tableValues="0.98 0.62 0.4"/><feFuncG type="table" tableValues="1 0.3 0.24"/><feFuncB type="table" tableValues="0.91 0.55 0.4"/><feFuncA type="table" tableValues="0 1"/></feComponentTransfer><feBlend mode="normal" in="componentTransfer" in2="SourceGraphic" result="blend"/><feGaussianBlur in="blend" stdDeviation="0.25" />';
    }

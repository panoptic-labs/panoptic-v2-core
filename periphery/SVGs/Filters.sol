...
library Filters {
    ...
    function rarity6() internal pure returns (string memory) {
        return
            '<feColorMatrix type="matrix" values=".33 .33 .33 0 0 .33 .33 .33 0 0 .33 .33 .33 0 0 0 0 0 1 0" in="SourceGraphic" result="colormatrix"/><feComponentTransfer in="colormatrix" result="componentTransfer"><feFuncR type="table" tableValues="0.16 0.36 0.98 0.96"/><feFuncG type="table" tableValues="0.52 0.82 0.95 0.91"/><feFuncB type="table" tableValues="0.76 0.9 0.83 0.41"/><feFuncA type="table" tableValues="0 1"/></feComponentTransfer><feBlend mode="overlay" in="componentTransfer" in2="SourceGraphic" result="blend"/>';
    }
    ...
    function rarity12() internal pure returns (string memory) {
        return
            '<feColorMatrix type="matrix" values=".33 .33 .33 0 0 .33 .33 .33 0 0 .33 .33 .33 0 0 0 0 0 1 0" in="SourceGraphic" result="colormatrix"/><feComponentTransfer in="colormatrix" result="componentTransfer"><feFuncR type="table" tableValues="0.08 0.78 1 1"/><feFuncG type="table" tableValues="0.07 0 0.96 0.41"/><feFuncB type="table" tableValues="0.27 0.22 0.87 0.41"/><feFuncA type="table" tableValues="0 1"/></feComponentTransfer><feBlend mode="overlay" in="componentTransfer" in2="SourceGraphic" result="blend"/>';
    }

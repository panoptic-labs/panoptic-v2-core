...
contract PanopticPool is Clone, Multicall {
    ...
    function _validateSolvency(
        ...
        (int24 spotTick, int24 medianTick, int24 latestTick, uint256 oraclePack) = riskEngine()
    ...
    function _checkSolvency(
        ...
        atTicks = riskEngine().getSolvencyTicks(currentTick, spotTick, medianTick, latestTick);

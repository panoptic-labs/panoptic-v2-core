...
contract CollateralTrackerV2 is Clone, ERC20Minimal, Multicall, TransientReentrancyGuard {
    ...
    /// @notice Prefix for the token name (i.e POPT-V2 USDC LP on ETH/USDC 30bps).
    ...
    function panopticPool() public pure returns (PanopticPoolV2) {
        return PanopticPoolV2(_getArgAddress(0));
    }

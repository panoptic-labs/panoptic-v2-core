...
library V4StateReader {
    ...
    function getFeeGrowthInside(
        ...
        (uint256 lowerOut0, uint256 lowerOut1) = getTickFeeGrowthOutside(manager, idV4, tickLower);
        (uint256 upperOut0, uint256 upperOut1) = getTickFeeGrowthOutside(manager, idV4, tickUpper);
        ...
        )
    {
        ...
        (liquidity, feeGrowthInside0LastX128, feeGrowthInside1LastX128) = getPositionInfo(
            manager,
            poolId,
            positionKey
        );

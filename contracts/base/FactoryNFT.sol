...
contract FactoryNFT is MetadataStore, ERC721 {
    ...
    /// @param symbol0 The symbol of the second token in the pool
    /// @param symbol1 The symbol of the first token in the pool
    ...
    /// @param rarity The rarity of the NFT
    /// @param symbol0 The symbol of the first token in the pool
    /// @param symbol1 The symbol of the second token in the pool
